...
def main(args):
    ...
    img_Cyan = colorInk(src, img_Cyan,90, 150 ,y_Cyan,255, 120, 255)
    img_Magenda = np.zeros([size[0], size[1],size[2]])
    img_Magenda = colorInk(src, img_Magenda,150, 180 ,y_MY,255, 120, 255)
    img_Yellow = np.zeros([size[0], size[1],size[2]])
    img_Yellow = colorInk(src, img_Yellow,20, 40 ,y_MY,255, 120, 255)
