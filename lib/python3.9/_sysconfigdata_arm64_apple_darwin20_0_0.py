...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/Users/sugaikazuaki/miniforge3/bin',
 'BINLIBDEST': '/Users/sugaikazuaki/miniforge3/lib/python3.9',
 ...
 'BLDSHARED': 'arm64-apple-darwin20.0.0-clang -bundle -undefined '
              ...
              '-Wl,-rpath,/Users/sugaikazuaki/miniforge3/lib '
              '-L/Users/sugaikazuaki/miniforge3/lib '
              ''
              ''
              '-Wl,-pie -Wl,-headerpad_max_install_names '
              '-Wl,-dead_strip_dylibs '
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG '
           ...
           '-isystem '
           '/Users/sugaikazuaki/miniforge3/include '
           ' '
           ' '
           '-arch arm64  '
           ''
 ...
 'CONFIGURE_CPPFLAGS': ''
                       ...
                       '-I/Users/sugaikazuaki/miniforge3/include',
 'CONFIGURE_LDFLAGS': ''
                      ''
                      '-Wl,-pie -Wl,-headerpad_max_install_names '
                      '-Wl,-dead_strip_dylibs '
 ...
 'CONFIG_ARGS': "'--prefix=/Users/sugaikazuaki/miniforge3' "
                "'--build=x86_64-apple-darwin13.4.0' "
                "'--host=arm64-apple-darwin20.0.0' '--enable-ipv6' "
                "'--with-ensurepip=no' "
                "'--with-tzpath=/Users/sugaikazuaki/miniforge3/share/zoneinfo:/Users/sugaikazuaki/miniforge3/share/tzinfo' "
                "'--with-computed-gotos' '--with-system-ffi' "
                "'--enable-loadable-sqlite-extensions' "
                "'--with-tcltk-includes=-I/Users/sugaikazuaki/miniforge3/include' "
                "'--with-tcltk-libs=-L/Users/sugaikazuaki/miniforge3/lib "
                "-ltcl8.6 -ltk8.6' '--with-platlibdir=lib' '--with-lto' "
                "'-oldincludedir=/Users/runner/miniforge3/conda-bld/python-split_1653670183479/_build_env/arm64-apple-darwin20.0.0/sysroot/usr/include' "
                ...
                '-mmacosx-version-min=11.0 '
                "-I/Users/sugaikazuaki/miniforge3/include' "
                "'PKG_CONFIG_PATH=/Users/sugaikazuaki/miniforge3/lib/pkgconfig'",
 'CONFINCLUDEDIR': '/Users/sugaikazuaki/miniforge3/include',
 'CONFINCLUDEPY': '/Users/sugaikazuaki/miniforge3/include/python3.9',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/Users/runner/miniforge3/conda-bld/python-split_1653670183479/work/build-static/coverage.info',
 'COVERAGE_REPORT': '/Users/runner/miniforge3/conda-bld/python-split_1653670183479/work/build-static/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             '-I/Users/runner/miniforge3/conda-bld/python-split_1653670183479/work/Include '
             ''
             ''
             '-D_FORTIFY_SOURCE=2 -isystem '
             '/Users/sugaikazuaki/miniforge3/include '
 ...
 'DESTDIRS': '/Users/sugaikazuaki/miniforge3 '
             '/Users/sugaikazuaki/miniforge3/lib '
             '/Users/sugaikazuaki/miniforge3/lib/python3.9 '
             '/Users/sugaikazuaki/miniforge3/lib/python3.9/lib-dynload',
 'DESTLIB': '/Users/sugaikazuaki/miniforge3/lib/python3.9',
 'DESTPATH': '',
 'DESTSHARED': '/Users/sugaikazuaki/miniforge3/lib/python3.9/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/Users/sugaikazuaki/miniforge3/include '
                   '/Users/sugaikazuaki/miniforge3/include '
                   '/Users/sugaikazuaki/miniforge3/include/python3.9 '
                   '/Users/sugaikazuaki/miniforge3/include/python3.9',
 'INCLUDEDIR': '/Users/sugaikazuaki/miniforge3/include',
 'INCLUDEPY': '/Users/sugaikazuaki/miniforge3/include/python3.9',
 ...
 'LDVERSION': '3.9',
 'LIBC': '',
 'LIBDEST': '/Users/sugaikazuaki/miniforge3/lib/python3.9',
 'LIBDIR': '/Users/sugaikazuaki/miniforge3/lib',
 'LIBFFI_INCLUDEDIR': '/Users/sugaikazuaki/miniforge3/include',
 'LIBM': '',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/Users/sugaikazuaki/miniforge3/lib/pkgconfig',
 'LIBPL': '/Users/sugaikazuaki/miniforge3/lib/python3.9/config-3.9-darwin',
 'LIBPYTHON': '',
 ...
 'LLVM_PROF_MERGER': '/Users/runner/miniforge3/conda-bld/python-split_1653670183479/_build_env/bin/llvm-profdata '
                     'merge -output=code.profclangd *.profclangr',
 'LN': 'ln',
 'LOCALMODLIBS': '',
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/Users/sugaikazuaki/miniforge3/lib/python3.9',
 'MACOSX_DEPLOYMENT_TARGET': '11.0',
 'MAINCC': 'arm64-apple-darwin20.0.0-clang',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': '/Users/runner/miniforge3/conda-bld/python-split_1653670183479/work/Modules/makesetup',
 'MANDIR': '/Users/sugaikazuaki/miniforge3/share/man',
 'MKDIR_P': '/Users/runner/miniforge3/conda-bld/python-split_1653670183479/work/install-sh '
            '-c -d',
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/Users/sugaikazuaki/miniforge3/include',
 'OPENSSL_LDFLAGS': '-L/Users/sugaikazuaki/miniforge3/lib',
 ...
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 'PY_BUILD_ENVIRON': '_PYTHON_PROJECT_BASE=/Users/runner/miniforge3/conda-bld/python-split_1653670183479/work/build-static '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/Users/runner/miniforge3/conda-bld/python-split_1653670183479/work/build-static/`cat '
                     'pybuilddir.txt`:)/Users/runner/miniforge3/conda-bld/python-split_1653670183479/work/Lib '
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare '
                             ...
                             '-Werror=implicit-function-declaration '
                             '-fvisibility=hidden  '
                             '-I/Users/runner/miniforge3/conda-bld/python-split_1653670183479/work/Include/internal '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/Users/sugaikazuaki/miniforge3/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'SRC_GDB_HOOKS': '/Users/runner/miniforge3/conda-bld/python-split_1653670183479/work/Tools/gdb/libpython.py',
 'STDC_HEADERS': 1,
 ...
 'TCLTK_INCLUDES': '-I/Users/sugaikazuaki/miniforge3/include',
 'TCLTK_LIBS': '-L/Users/sugaikazuaki/miniforge3/lib '
               '-ltcl8.6 -ltk8.6',
 'TESTOPTS': '',
 'TESTPATH': '',
 ...
 'TESTRUNNER': './python.exe '
               '/Users/runner/miniforge3/conda-bld/python-split_1653670183479/work/Tools/scripts/run_tests.py',
 'TESTTIMEOUT': 1200,
 'TIMEMODULE_LIB': 0,
 'TIME_WITH_SYS_TIME': 1,
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/Users/sugaikazuaki/miniforge3/share/zoneinfo:/Users/sugaikazuaki/miniforge3/share/tzinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 'UPDATE_FILE': 'python3.9 '
                '/Users/runner/miniforge3/conda-bld/python-split_1653670183479/work/Tools/scripts/update_file.py',
 'USE_COMPUTED_GOTOS': 1,
 'VERSION': '3.9',
 'VPATH': '/Users/runner/miniforge3/conda-bld/python-split_1653670183479/work',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/Users/runner/miniforge3/conda-bld/python-split_1653670183479/work/build-static',
 'abs_srcdir': '/Users/runner/miniforge3/conda-bld/python-split_1653670183479/work',
 'datarootdir': '/Users/sugaikazuaki/miniforge3/share',
 'exec_prefix': '/Users/sugaikazuaki/miniforge3',
 'prefix': '/Users/sugaikazuaki/miniforge3',
 'srcdir': '/Users/runner/miniforge3/conda-bld/python-split_1653670183479/work'}
